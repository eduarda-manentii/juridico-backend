...
public class ProcessoMapper {
    ...
    public ProcessoDto toDto(Processo processo) {
        List<ParteEnvolvidaDto> lista = processo.getParteEnvolvida()
                .stream()
        ...
        return ProcessoDto.builder()
                ...
                .parteEnvolvidaDtos(lista)
                .andamentoProcessualDto(andamentoProcessualMapper.toDto(processo.getAndamentoProcessual()))
    ...
    public Processo toEntity(ProcessoDto processoDto) {
        return Processo.builder()
                ...
                .parteEnvolvida(processoDto.getParteEnvolvidaDtos()
                        .stream()
                        .map(parteEnvolvidaMapper::toEntity)
                        .collect(Collectors.toList()))
                .andamentoProcessual(andamentoProcessualMapper.toEntity(processoDto.getAndamentoProcessualDto()))
